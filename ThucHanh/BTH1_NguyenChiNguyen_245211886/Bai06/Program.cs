...
namespace Bai06
{
    class Program
    {
        ...
        // a. Xuat ma tran
            Console.WriteLine("Ma tran duoc khoi tao ngau nhien: ");
            matrix.Print();
        ...
        // c. Xuat dong co tong lon nhat
            Console.WriteLine($"Dong co tong lon nhat la dong so {matrix.FindMaxSumRow()}");

        // d. Tinh tong cac so khong phai la so nguyen to
            Console.WriteLine($"Tong cac so khong phai la so nguyen to la {matrix.FindNonPrimeSum()}");
