...
namespace BTH1.Bai01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.Write("Nhap so luong phan tu cua mang (> 0): ");
            ...
            // In mang ra man hinh
            Console.WriteLine("Mang da duoc khoi tao ngau nhien la: ");
            PrintArray(arr, n);

            // a. tinh tong cac so le trong mang
            Console.WriteLine("\na. Tong cac so le: " + CalculateOddSum(arr, n));

            // b. dem cac so nguyen to trong mang
            Console.WriteLine("b. So luong so nguyen to: " + CountPrime(arr, n));

            // c. tim so chinh phuong nho nhat
            Console.WriteLine("c. So chinh phuong nho nhat la: " + FindMinPerfectSquare(arr, n));
        }
